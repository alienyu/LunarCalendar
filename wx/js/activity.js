...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        var selb = mobiScroll.datetime(obj1, {
	            ...
	            onSet: function (event, inst) {
	                ...
	                if(obj2 =='.startCon'){//若修改的是开始时间的日期，则指定提醒时间日期等于开始时间，结束时间比开始时间大10分钟
	                    ...
	                    $('.endCon').html(selectedDateArr[0] + "年" + (parseInt(selectedDateArr[1]) + 1) + "月" + that.tf(selectedDateArr[2]) + "日" + " " + theWeek + " " +endHour+":"+endMinute);
	...
	//                console.log(data);
	    ...
	    renderPage:function(){
	        ...
	        this.selectTimes('#startTime', '.startCon').setVal(new Date(that.setInitTime($('.startTime'))));
	        this.selectTimes('#endTime', '.endCon').setVal(new Date(that.setInitTime($('.endTime'))));
