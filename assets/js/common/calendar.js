...
var Calendar = (function () {
    ...
    function pageDate(offset, _year, _month, _day) {
        ...
        day = _day ? _day : (current.day > LunarCalendar.getSolarMonthDays(year,month-1) ? LunarCalendar.getSolarMonthDays(year,month-1) : current.day);
    ...
    function slide(offset) {
        ...
        if (offset > 0) {//左滑
            timer = setTimeout(function () {
                setSlidePos({time: 100, pos: pageWidth * -1});
            }, 50);
        } else { //右滑
            timer = setTimeout(function () {
                setSlidePos({time: 100, pos: pageWidth});
            }, 50);
        }
    };
