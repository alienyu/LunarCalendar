...
var mobiscroll = require("../common/mobiscroll.js");
var tranCalendar = require("../common/transCalendar.js");
...
//            console.log(wordItem.size());
    ...
    $('.lucky02').on('swipeeft', function (event) {
    ...
    $('.lucky02').on('swipeight', function (event) {
        clearInterval(timer2);
        clearInterval(timer1);
